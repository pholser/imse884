...
def test_format_ip(lp_solve_format_ip):
    assert lp_solve_format_ip == dedent('''
        ...
        s1_0: x0,0 + x1,0 + x2,0 + x3,0 + x4,0 - w0 >= 0
        s1_1: x0,1 + x1,1 + x2,1 + x3,1 + x4,1 - w1 >= 0
        s1_2: x0,2 + x1,2 + x2,2 + x3,2 + x4,2 - w2 >= 0
        s1_3: x0,3 + x1,3 + x2,3 + x3,3 + x4,3 - w3 >= 0
        s1_4: x0,4 + x1,4 + x2,4 + x3,4 + x4,4 - w4 >= 0
        s2_0: w0 - w1 >= 0
        s2_1: w1 - w2 >= 0
        s2_2: w2 - w3 >= 0
        s2_3: w3 - w4 >= 0
